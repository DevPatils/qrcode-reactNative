...
const CustomButton = ({ title, handlepress, containerStyles, textStyles, isLoading }: { title: string | any, handlepress: any, containerStyles: string, textStyles: string, isLoading: boolean }) => {
    return (
