    ...
    <View className="flex flex-1  bg-white py-16 px-6">
      ...
      <View className='flex flex-row justify-between items-center rounded-xl py-4 bg-green-pea-300'>
        <View className='flex flex-col px-3 flex-1'>
          <Text style={{ fontFamily: "gilroy-medium" }} className='text-lg uppercase text-green-800'>Recycle 3 plastics</Text>
          <Text style={{ fontFamily: "gilroy-bold" }} className='text-3xl text-green-pea-900'>WIN 500 POINTS</Text>
        </View>
      ...
      <View className="flex flex-col justify-center items-center my-6">
        <CustomButton
          ...
          containerStyles="bg-green-pea-300 p-6 rounded-[100%]"
